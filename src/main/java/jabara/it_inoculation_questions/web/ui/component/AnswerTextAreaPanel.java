 ...
 * @author jabaraster
 */
public class AnswerTextAreaPanel extends TextComponentPanel<TextArea<List<AnswerValue>>> {
    ...
    @Override
    protected TextArea<List<AnswerValue>> createAnswerText() {
        final TextArea<List<AnswerValue>> ret = new TextArea<List<AnswerValue>>("answerText", this.answerValuesModel) { //$NON-NLS-1$
