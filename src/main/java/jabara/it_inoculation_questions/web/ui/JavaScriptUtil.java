...
public final class JavaScriptUtil {
     ...
     * 
     */
    public static final String  COMMON_JS_FILE_PATH = "ItInoculationQuestions.js";           //$NON-NLS-1$
    ...
    public static String getFocusScript(final Component pTag) {
        ...
        return "ItInoculationQuestions.focus('" + pTag.getMarkupId() + "');"; //$NON-NLS-1$ //$NON-NLS-2$
    }
}
